...
import com.example.market.databinding.RcItemListProductsBinding

class ListProductsAdapter:ListAdapter<ProductResponseData,ListProductsAdapter.ListProductsVH>(diffUtil) {
